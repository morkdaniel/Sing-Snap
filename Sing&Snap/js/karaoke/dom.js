    ...
    card.innerHTML = `
      ...
      <div class="karaoke__card-info">
        ...
        <div class="karaoke__card-controls">
          <button class="karaoke__control-btn karaoke__play-btn" onclick="window.location.href='player.html?videoId=${song.videoId}&title=${encodeURIComponent(song.title)}'">▶ Play</button>
        </div>
      </div>
